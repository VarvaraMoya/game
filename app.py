...
def start_game(): 
    ...
    while True: #Запускаем бесконечный цикл, в котором будет происходить игра.
        ...
        if guess.lower() == 'стоп':
            print(f"Игра окончена. Загаданное число было: {secret_number}. Спасибо за игру!") #Проверяем, ввел ли пользователь "стоп" (в любом регистре).
...
def main():
    """Основная фунция, которая управляет началом игры и выводит правила."""
